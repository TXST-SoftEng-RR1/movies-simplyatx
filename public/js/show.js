...
class show {
    ...
    constructEntry() {
        ...
        result +=         "<div>";
        result +=             "<button id='" + this.titleId + "-e1-btn' type=\"button\" class=\"btn btn-info\" onclick=\"updateSingleEmojiCountForTitle('" + this.titleId + "', 'e2')\">";
        ...
        result +=             "</button>  &nbsp;";
        result +=             "<button id='" + this.titleId + "-e2-btn' type=\"button\" class=\"btn btn-info\" onclick=\"updateSingleEmojiCountForTitle('" + this.titleId + "', 'e4')\">";
        ...
        result +=             "</button>  &nbsp;";
        result +=             "<button id='" + this.titleId + "-e3-btn' type=\"button\" class=\"btn btn-info\" onclick=\"updateSingleEmojiCountForTitle('" + this.titleId + "', 'e5')\">";
        ...
        result +=             "</button>  &nbsp;";
        result +=             "<button id='" + this.titleId + "-e4-btn' type=\"button\" class=\"btn btn-info\" onclick=\"updateSingleEmojiCountForTitle('" + this.titleId + "', 'e6')\">";
        ...
        result +=             "</button>  &nbsp;";
        result +=             "<button id='" + this.titleId + "-e5-btn' type=\"button\" class=\"btn btn-info\" onclick=\"updateSingleEmojiCountForTitle('" + this.titleId + "', 'e7')\">";
        ...
        result +=             "</button>  &nbsp;";
        result +=             "<button id='" + this.titleId + "-e6-btn' type=\"button\" class=\"btn btn-info\" onclick=updateSingleEmojiCountForTitle('" + this.titleId + "', 'e8')\">";
        ...
        result +=             "</button>  &nbsp;";
        result +=             "<button id='" + this.titleId + "-e7-btn' type=\"button\" class=\"btn btn-info\" onclick=\"updateSingleEmojiCountForTitle('" + this.titleId + "', 'e9')\">";
